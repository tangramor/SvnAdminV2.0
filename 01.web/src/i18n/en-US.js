module.exports = {
    ...
    index: {
        ...
        color_running_jammed: 'Running Jammed',
        color_running_slow: 'Running Slow',
        color_running_normal: 'Running Normal',
        color_running_quick: 'Running Quick',
    ...
    layout: {
        ...
        信息统计: 'Statics',
        'Statistics Information': 'Statics',
        SVN仓库: 'SVN Repository',
        'SVN Repository': 'SVN Repository',
        SVN用户: 'SVN Users',
        'SVN User': 'SVN Users',
        SVN分组: 'SVN Groups',
        'SVN Group': 'SVN Groups',
        运维: 'Operations',
...
user2:passwd2`,
    ...
    setting: {
        ...
        pathInfo: 'Path Info',
        globalAuthz: 'Use Global Authz File (authz)',
        globalAuthzTip: 'If this option is enabled (default), the system will use the global authz file to control the access to all repositories, and the repository-specific authz file (<repository>/conf/authz) will be ignored.',
        ...
        svn_single_authz: 'Use Global Authz File',
        仓库权限文件: 'Repository Permissions File',
        每个仓库使用各自的authz文件: 'Each repository\'s own authz file (svn_single_authz=false)',
        ...
        'Admin Modify User Name': 'Admin Modify User Name',
        管理人员修改密码: 'Admin Modify Password',
        'Admin Modify Password': 'Admin Modify Password',
        SVN用户修改密码: 'SVN User Modify Password',
        'SVN User Modify Password': 'SVN User Modify Password',
