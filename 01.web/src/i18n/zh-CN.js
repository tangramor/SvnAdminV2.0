module.exports = {
    ...
    index: {
        ...
        logs: '运行日志',
        svnAlias: 'SVN别名',
        color_running_jammed: '运行堵塞',
        color_running_slow: '运行缓慢',
        color_running_normal: '运行正常',
        color_running_quick: '运行流畅',
        color_unknown: '未知',
    },
    layout: {
        SVNAdmin: 'SVNAdmin',
...
user2:passwd2`,
    ...
    setting: {
        ...
        pathInfo: '路径信息',
        globalAuthz: '使用全局授权文件(authz)',
        globalAuthzTip: '如果启用则所有仓库都使用全局授权文件(authz)进行权限控制（缺省为启用）。否则每个仓库则使用仓库自身的授权文件（仓库目录/conf/authz）进行权限控制。',
        ...
        default_lang: '缺省语言',
        home_directory: '主目录',
        repo_parent_directory: '仓库父目录',
        repo_config_file: '仓库配置文件',
        svn_single_authz: '使用全局authz文件',
        repo_permission_file: '仓库权限文件',
        each_repo_use_its_own_authz_file: '每个仓库使用各自的authz文件（使用全局authz文件 = false）',
        user_account_file: '用户账号文件',
        backup_directory: '备份目录',
        svnserve_env_file: 'svnserve环境变量文件',
        user_login: '用户登录',
